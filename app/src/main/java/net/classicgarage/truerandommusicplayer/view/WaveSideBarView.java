...
public class WaveSideBarView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.FlingGalleryView);
            mTextColor = a.getColor(R.styleable.FlingGalleryView_sidebarTextColor, mTextColor);
            mTextColorChoose = a.getColor(R.styleable.FlingGalleryView_sidebarChooseTextColor, mTextColorChoose);
            mTextSize = a.getFloat(R.styleable.FlingGalleryView_sidebarTextSize, mTextSize);
            mLargeTextSize = a.getFloat(R.styleable.FlingGalleryView_sidebarLargeTextSize, mLargeTextSize);
            mWaveColor = a.getColor(R.styleable.FlingGalleryView_sidebarBackgroundColor, mWaveColor);
            mRadius = a.getInt(R.styleable.FlingGalleryView_sidebarRadius, context.getResources().getDimensionPixelSize(R.dimen.radius_sidebar));
            mBallRadius = a.getInt(R.styleable.FlingGalleryView_sidebarBallRadius, context.getResources().getDimensionPixelSize(R.dimen.ball_radius_sidebar));
            a.recycle();
        }
